...
class RateLimitPlugin:
    ...
    async def startup(self, app: "FastAPI") -> None:
        ...
        """
        logger = get_app_logger()
        logger.debug(f"RateLimitPlugin startup - {self.rate_limit_middleware_class.__name__}")
    ...
    async def shutdown(self, app: "FastAPI") -> None:
        ...
        """
        logger = get_app_logger()
        logger.debug(f"RateLimitPlugin shutdown - {self.rate_limit_middleware_class.__name__}")
