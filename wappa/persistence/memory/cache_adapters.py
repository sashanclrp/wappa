"""
Memory cache adapters that implement the ICache interface.

These adapters wrap Memory handlers to provide a uniform ICache interface
...
class MemoryStateCacheAdapter(ICache):
    """Adapter that makes MemoryStateHandler implement ICache interface."""

    def __init__(self, tenant_id: str, user_id: str):
        self._handler = MemoryStateHandler(tenant=tenant_id, user_id=user_id)
...
class MemoryUserCacheAdapter(ICache):
    """Adapter that makes MemoryUser implement ICache interface."""

    def __init__(self, tenant_id: str, user_id: str):
        self._handler = MemoryUser(tenant=tenant_id, user_id=user_id)
